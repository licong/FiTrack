...
public class ResetPasswordTask extends AsyncTask<String, Void, Result> {
	...
	protected void onPreExecute() {
		progressDialog = ProgressDialog.show(activity, "", "Sending Password...", true);
	}
	...
	protected Result doInBackground(String... params) {
		...
		try {
			result.setMessage(apiClient.resetPassword(email));
